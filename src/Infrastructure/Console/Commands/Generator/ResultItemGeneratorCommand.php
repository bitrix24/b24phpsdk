...
final readonly class DefaultResultItemGeneratorWorkflow
{
    ...
    private function buildOpenApiPayload(string $methodName): ?\Bitrix24\SDK\OpenApi\Domain\ResultItem\ResultItemPayload
    {
    ...
    private function buildDocsPayload(string $methodName): \Bitrix24\SDK\OpenApi\Domain\ResultItem\ResultItemPayload
    {
    ...
    private function readPayload(string $payloadPath): \Bitrix24\SDK\OpenApi\Domain\ResultItem\ResultItemPayload
    {
        return $this->payloadSerializer->decode($this->readFile($payloadPath));
    }

    private function readReport(string $reportPath): \Bitrix24\SDK\OpenApi\Domain\ResultItem\ResultItemVerificationReport
    {
