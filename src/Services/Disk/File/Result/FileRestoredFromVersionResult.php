...
/**
 * File restored from version result
 */
class FileRestoredFromVersionResult extends AbstractResult
{
    /**
     * Get file restored from version
     *
    ...
    /**
     * Check if restore from version operation was successful
     *
     * @throws BaseException
     */
