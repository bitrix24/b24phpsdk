...
/**
 * File version uploaded result
 */
class FileVersionUploadedResult extends AbstractResult
{
    /**
     * Get file with new version
     *
    ...
    /**
     * Check if version upload operation was successful
     *
     * @throws BaseException
     */
