...
use Bitrix24\SDK\Services\CRM\Enum\CrmSettingsMode;
 ...
 * @property-read CrmSettingsMode $ENUM
 */
class CrmSettingsModeItemResult extends AbstractCrmItem
{
    public function __get($offset)
    {
        return match ($offset) {
            'ENUM' => CrmSettingsMode::from($this->data['ID']),
