...
class AddedTypeItemResult extends AbstractResult implements AddedItemIdResultInterface
{
    ...
    {
        return (int)$this->getCoreResponse()->getResponseData()->getResult()['type']['id'];
    }
}