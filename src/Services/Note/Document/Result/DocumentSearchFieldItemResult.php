...
/**
 * Field metadata entry returned by `note.document.search.field.get` / `note.document.search.field.list`.
 *
 ...
 */
class DocumentSearchFieldItemResult extends AbstractAnnotatedItem
{
}
