...
/**
 * Field metadata entry returned by `note.document.tree.field.get` / `note.document.tree.field.list`.
 *
 ...
 */
class DocumentTreeFieldItemResult extends AbstractAnnotatedItem
{
}
