...
build-examples-for-documentation:
	php bin/console b24-dev:generate-examples --folder=diplodoc/var/ --prompt-template=diplodoc/file-templates/gpt/master-prompt-template.md --example-template=diplodoc/file-templates/examples/master-example.php --openai-api-key=$(DOCUMENTATION_OPEN_AI_API_KEY)
