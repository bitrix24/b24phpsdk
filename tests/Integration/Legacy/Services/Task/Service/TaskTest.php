...
/**
 * @deprecated Tests for the legacy v1 Task service. Will be removed once v3 reaches feature parity.
 */
...
class TaskTest extends TestCase
{
    ...
    public function testGetAccess(): void
    {
        ...
        $accesses = $this->taskService->getAccess($taskId, [$userId, $user2Id]);
        self::assertInstanceOf(AccessesResult::class, $accesses);
        $this->assertGreaterThanOrEqual(
            1,
            $accesses->getAccesses()[0]->getUserId()
        );
