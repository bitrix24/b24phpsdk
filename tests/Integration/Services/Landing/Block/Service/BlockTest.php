...
class BlockTest extends TestCase
{
    ...
    {
        $this->blockService = Fabric::getServiceBuilder()->getLandingScope()->block();
    ...
    {
        try {
            $siteService = Fabric::getServiceBuilder()->getLandingScope()->site();
            $pageService = Fabric::getServiceBuilder()->getLandingScope()->page();
    ...
    private function createTestPageWithBlocks(): int
    {
        ...
        if ($pageId > 0) {
            ...
            try {
                $blockService = Fabric::getServiceBuilder()->getLandingScope()->block();
