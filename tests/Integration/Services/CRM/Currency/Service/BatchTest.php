...
class BatchTest extends TestCase
{
     ...
     */
    #[\PHPUnit\Framework\Attributes\TestDox('Batch add currencies')]
     ...
     * @throws \Bitrix24\SDK\Core\Exceptions\BaseException
     */
    #[\PHPUnit\Framework\Attributes\TestDox('Batch delete currencies')]
    public function testBatchDelete(): void
    {
        ...
        $items = [];
        foreach (self::TEST_LETTERS as $letter) {
            $items[] = self::CURRENCY_PREFIX.$letter;
        }

        foreach ($this->currencyService->batch->delete($items) as $deleteResult) {
            $cnt++;
        }
     ...
     * @throws \Bitrix24\SDK\Core\Exceptions\BaseException
     */
    #[\PHPUnit\Framework\Attributes\TestDox('Batch update currencies')]
