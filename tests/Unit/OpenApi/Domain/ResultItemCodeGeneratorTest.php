...
class ResultItemCodeGeneratorTest extends TestCase
{
    ...
    public function itGeneratesPropertyAnnotationsAndCarbonImportForTemporalFields(): void
    {
        ...
        $this->assertStringContainsString('@property-read ' . CarbonImmutable::class . '|null $date_create', $code);
        $this->assertStringContainsString('@property-read ' . CarbonImmutable::class . '|null $birthday', $code);
